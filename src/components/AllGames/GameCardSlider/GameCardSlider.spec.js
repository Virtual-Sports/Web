...
describe('GameCardSlider component', () => {
    it('should render without crashing', () => {
        shallow(<GameCardSlider id={0} title={'title'} />)
    })

    it('should contain image tag and p tag', () => {
        const wrapper = shallow(<GameCardSlider id={0} title={'title'} />)
    ...
    it('should display default image if no img prop given', () => {
        const wrapper = shallow(<GameCardSlider id={0} />)
    ...
    it('should call any passed in onError after an image load error', () => {
        const wrapper = shallow(<GameCardSlider id={0} img={'123.123'} />)
